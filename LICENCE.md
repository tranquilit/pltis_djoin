...
The files in this repository are part of the Tranquil IT Softwares, and are released under a disjunctive MPL 1.1/GPL 2.0/LGPL 2.1 three-license. Its use in any project expects the full acceptance of its licensing terms.
...
But please do not forget to put somewhere in your credit window or documentation, a link to https://github.com/tranquilit if you use any of the units published under this tri-license.
...
*This software uses some third-party code of the Tranquil IT DJoin framework (C) 2023 Tranquil IT - https://github.com/tranquilit - under Mozilla Public License 1.1; modified source code is available at http://SoftwareCompany.com/MPL*
...
If you want to include part of the framework source code in your own open-source project, you may publish it with a comment similar to this one:
    ...
    {
      Will extract informations from a djoin blob and apply them to the associated AD.

      Sample based on official Tranquil IT's sample
      "examples\Extract - DJoinExtract.lpr"

      Tranquil IT DJoin framework. Copyright (C) 2023 Tranquil IT
        Tranquil IT - https://www.tranquil.it
...
If you feel like you really have to purchase a license for our libraries, *Tranquil IT*, will sell you one. Please contact us directly for a contract proposal.
